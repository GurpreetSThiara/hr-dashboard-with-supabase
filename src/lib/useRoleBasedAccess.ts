...
type Permission = 'view_dashboard' | 'view_employees' | 'manage_employees' | 'view_leaves' | 'approve_leaves' | 'manage_policies' | 'view_attendance' | 'manage_attendance' | 'view_hierarchy' | 'manage_hierarchy' | 'admin_panel';

// Role tier definitions (lower number = higher role)
const ROLE_TIERS = {
  'Super Admin': 1,
  'Owner': 2,
  'Admin': 3,
...
// Permission matrix: roles that have access
