...
const ROLES = [
  { name: 'Super Admin',   tier: 1,  color: 'text-purple-800 bg-purple-100 border-purple-200' },
  { name: 'Owner',         tier: 2,  color: 'text-purple-700 bg-purple-50 border-purple-200' },
  { name: 'Admin',         tier: 3,  color: 'text-blue-800 bg-blue-100 border-blue-200' },
  { name: 'HR Admin',      tier: 4,  color: 'text-blue-700 bg-blue-50 border-blue-200' },
  { name: 'HR Manager',    tier: 5,  color: 'text-blue-600 bg-blue-50 border-blue-100' },
  { name: 'HR Executive',  tier: 6,  color: 'text-cyan-800 bg-cyan-100 border-cyan-200' },
  { name: 'Recruiter',     tier: 7,  color: 'text-cyan-700 bg-cyan-50 border-cyan-200' },
  { name: 'Payroll Manager', tier: 8, color: 'text-emerald-800 bg-emerald-100 border-emerald-200' },
  { name: 'Finance',       tier: 9,  color: 'text-emerald-800 bg-emerald-50 border-emerald-100' },
  { name: 'Compliance',    tier: 10, color: 'text-teal-800 bg-teal-100 border-teal-200' },
  { name: 'IT Ops',        tier: 11, color: 'text-teal-700 bg-teal-50 border-teal-200' },
  { name: 'Director',      tier: 12, color: 'text-amber-800 bg-amber-100 border-amber-200' },
  { name: 'Manager',       tier: 13, color: 'text-amber-700 bg-amber-50 border-amber-200' },
  ...
  { name: 'Contractor',    tier: 16, color: 'text-slate-600 bg-slate-50 border-slate-200' },
